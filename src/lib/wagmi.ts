...
export const wagmiConfig = getDefaultConfig({
  ...
  chains: [monadTestnet, arcTestnet, sepolia, baseSepolia, arbitrumSepolia, bscTestnet],
  ssr: false,
});

export const SUPPORTED_CHAINS = [
  { id: monadTestnet.id, name: "Monad Testnet", symbol: "MON", color: "#836EF9", short: "MON", primary: true },
  { id: arcTestnet.id, name: "Arc Testnet", symbol: "USDC", color: "#2775CA", short: "ARC" },
