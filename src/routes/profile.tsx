...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your TaQtik wallet identity and game stats." },
    ],
  }),
    ...
    <div className="space-y-8 max-w-3xl">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Your wallet is your primary TaQtik identity for matches, stakes, and fair-play history.
        </p>
      </div>
